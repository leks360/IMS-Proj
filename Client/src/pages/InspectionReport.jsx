...
import AddInspection from '../components/addInspection.jsx';
...
export default function Levies(props) {
    ...
    useEffect(()=>{
       const fetch=async()=>{
        ...
        //getAllPaginated
        const da=await axiosInstance.get(`/inspection/getAllPaginated/${ser}?page=${page}&limit=${limit}`);
        ...
        <Header/>
            ...
            <CreateDiv> 
               ...
               <Btn onClick={e=>setOpen(false)}>X</Btn>
                <AddInspection name={ser} setOpen={setOpen} setReload={setReload}/>
                </Card>
            ...
            <Inputs>
                ...
                <ButtonTemplate onClick={(e)=>{ser=='none'?alert("Pl choose Quarry"):setOpen(true)}}>Add Penalty</ButtonTemplate>
            </Inputs>
            
            
        {data!=null &&<BasicTable dataa={data} setLimit={setLimit} setPage={setPage} page={page} which="inspection" />}
        </Wrapper>
